...
_TAILS = (
    ...
    "달라", "달라고", "주라", "바랍니다", "바람",
    # 피동/완료
    "됐는데", "됐다고", "됐어요", "됐다", "됐고", "됐음", "된다고",
    # 경북 사투리 의문·인용 어미 (전화 민원은 대부분 이 꼴로 끝난다)
    #   "농로가 유실됐다 카는데", "누가 담당하노", "어데 전화하믄 되노"
    "카는데", "카더라", "캤는데", "캅니다", "카능교",
    "하능교", "합니꺼", "습니꺼", "인교", "잉교",
    "하노", "하나", "하꼬", "하믄", "하문", "이고",
    # 조사
...
STOPWORDS = frozenset(
    ...
    전화 전화기 연락 연락처 문의처 담당 담당자 소관 관할 부서 과에 국에
    동네 우리동네 저희동네 마을 집앞 여쭤볼 물어볼 물어보 알아볼 데가 곳이

    어데 어데고 어디고 어디꼬 어딘고 어느과 어느국
    어디서 어디에 어디로 어디까지 어데서 어데로 어드메 어디쯤 어디든
    되노 되나 되노요 하노 하나 하꼬 하믄 하문 누가 누구고 뭐꼬 우째 우예
    카는데 카더라 캤는데 카능교 하능교 합니꺼 캅니다 그카고 그카는데
    """.split()
)
